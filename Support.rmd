...
support = support[which(support$RightFam1!='NA'),]
support = support[which(support$LeftFam1!='NA'),]
support = support[which(support$RightFam2!='NA'),]
support = support[which(support$LeftFam2!='NA'),]
...
#support$hab = mean((support$RightFam1+support$LeftFam1)/2)-mean((support$LeftFam2+support$RightFam2)/2)
...
#support = support[which(support$hab > 0),]
#support = support[which(support$habYN == 1),]
```
...
#support = support[which(support$Age>7.3),]
#support = support[which(support$Age<=7.3),] #10 participants
#support = support[which(support$Age>7.3),] #13 participants

#look at effect of age on response
...
There was a difference in looking times between the average looking time of all three Possible test events (M =
...
###Young vs old average trial performance
```{r young_vs_old_data}
