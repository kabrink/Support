...
medians <- matrix(c(median(youngsupport$ContactTest1),median(youngsupport$ContactTest2),median(youngsupport$ContactTest3),median(youngsupport$NoContactTest1),median(youngsupport$NoContactTest2),median(youngsupport$NoContactTest3)),ncol=3,byrow=TRUE)
colnames(medians) <- c("Test Trial 1","Test Trial 2","Test Trial 3")
rownames(medians) <- c("Contact","No Contact")
medians <- as.table(medians)
...
medians <- matrix(c(median(oldsupport$ContactTest1),median(oldsupport$ContactTest2),median(oldsupport$ContactTest3),median(oldsupport$NoContactTest1),median(oldsupport$NoContactTest2),median(oldsupport$NoContactTest3)),ncol=3,byrow=TRUE)
colnames(medians) <- c("Test Trial 1","Test Trial 2","Test Trial 3")
rownames(medians) <- c("Contact","No Contact")
medians <- as.table(medians)
...
For infants younger than 7.3 months, there was no difference in looking times between the first Possible test event (M =
...
For infants younger than 7.3 months, there was no difference in looking times between the second Possible test event (M = 
...
For infants younger than 7.3 months, there was no difference in looking times between the third Possible test event (M =
...
For infants older than 7.3 months, there was no difference in looking times between the first Possible test event (M =
...
For infants older than 7.3 months, there was no difference in looking times between the second Possible test event (M = 
...
For infants older than 7.3 months, there was no difference in looking times between the third Possible test event (M =
...
g.range = range(0,ceiling(max(medians))+10)
...
##Breakdown of young (<=7.3 months) vs old infants (>7.3)
```{r young_vs_old_data}
youngsupport = support[which(support$Age<=7.3),]
oldsupport = support[which(support$Age>7.3),]
              
pander(table(support$Age<=7.3, support$Order))
pander(table(support$Age<=7.3, support$Sex))

pander(table(youngsupport$Sex,youngsupport$Order), caption="Infants younger than 7.3 months")
pander(table(oldsupport$Sex,oldsupport$Order), caption="Infants older than 7.3 months")
```
